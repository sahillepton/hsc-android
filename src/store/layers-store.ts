...
interface LayerState {
    ...
    setDrawingMode : (drawingMode : "point" | "polygon" | "line" | "azimuthal" | null) => void
    ...
    setFocusLayerRequest : (focusLayerRequest : {
        layerId: string;
        bounds: [number, number, number, number];
        center: [number, number];
        isSinglePoint: boolean;
...
const useLayerStore = create<LayerState>()((set, get) => ({
    ...
    setNetworkLayersVisible: (networkLayersVisible) => set({ networkLayersVisible }),
    nodeIconMappings: {},
    setNodeIconMappings: (nodeIconMappings) => set({ nodeIconMappings }),
    getNodeIcon: (nodeId : string) => get().nodeIconMappings[nodeId],
    setNodeIcon: (nodeId : string, iconName : string) => set((state) => ({ nodeIconMappings: { ...state.nodeIconMappings, [nodeId]: iconName } })),
...
export const useNodeDialog = () => {
    ...
    const setIsNodeDialogOpen = useLayerStore((state) => state.setIsNodeDialogOpen)
...
export const useNetworkLayersVisible = () => {
    const networkLayersVisible = useLayerStore((state) => state.networkLayersVisible)
    const setNetworkLayersVisible = useLayerStore((state) => state.setNetworkLayersVisible)
...
export const useNodeIconMappings = () => {
    ...
    const setNodeIconMappings = useLayerStore((state) => state.setNodeIconMappings)
...
export const useFocusLayerRequest = () => {
    ...
    const setFocusLayerRequest = useLayerStore((state) => state.setFocusLayerRequest)
    const focusLayer = useLayerStore((state) => state.focusLayer)
    const clearLayerFocusRequest = useLayerStore((state) => state.clearLayerFocusRequest)
